      ...
      <div id="about">
        ...
        >
          <path
            ...
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M0 255.245V0C62.1372 10.7775 137.184 17.0765 218 17.0765C298.816 17.0765 373.863 10.7775 436 0V255.245C373.863 244.468 298.816 238.169 218 238.169C137.184 238.169 62.1372 244.468 0 255.245Z"
            fill="black"
          />
          <path
            id="screen"
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M6 252.457V4C66.4846 14.4909 139.535 20.6223 218.202 20.6223C296.869 20.6223 369.92 14.4909 430.404 4V252.457C369.92 241.966 296.869 235.834 218.202 235.834C139.535 235.834 66.4846 241.966 6 252.457Z"
            fill="#0F1010"
          />
          <path
            id="glare"
            ...
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M151.569 19.1286C98.3593 16.714 49.0036 11.4589 6 4V252.457C32.4098 247.876 61.2153 244.126 91.838 241.356L151.569 19.1286Z"
            fill="#F3F2F2"
          />
          <path
            id="mouse"
